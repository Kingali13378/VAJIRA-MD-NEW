...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=bAEnGRCL#oCvX49RH4Q2FyeaC3wjc8IqutkztTBG_RCpdEvzGL8w' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '923318086563' : process.env.OWNER_NUMBER,   
